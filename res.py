...
def main():
    ...
    for order in orders:
        ...
        output_file = f"{order}_res_scores.csv"

        sequences_with_headers = fasta_to_array(fasta_file)
        calculate_and_save_scores_to_csv(sequences_with_headers, output_file)
